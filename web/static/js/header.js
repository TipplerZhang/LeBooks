...
function header(name){
    ...
    str += "	<h1>";
    str += "		<a style=\"logo_style\" title=\"lebooks租赁平台\" href=\"index.action\"></a>";
    str += "		<a href=\"index.action\" title=\"lebooks租赁平台\"><img alt=\"lebooks租赁平台\" calss=\"img_logo\" src=\"static/images/logo.jpg\"></a>";
    str += "	</h1>";
    str += "</div>";
    str += "<div class=\"banner\">";
    str += "	<a title=\"lebooks租赁平台\" href=\"javascript:void(0);\"></a>";
    str += "	<a title=\"lebooks租赁平台\" href=\"index.action\">";
    str += "	<em>";
    str += "	<img height=\"80\" width=\"552\" alt=\"lebooks租赁平台\" border=\"0\" src=\"static/images/banner.gif\">";
    str += "	</em></a>";
    str += "</div>";
    str += "<div class=\"rlink\">";
    str += "	<ul>";
